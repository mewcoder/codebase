...
console.log("prevVnode:" + JSON.stringify(prevVnode)); // 将 VNode 渲染成真实 DOM

patch(document.getElementById("app"), prevVnode); // 两秒之后重渲染
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4970" + '/');
